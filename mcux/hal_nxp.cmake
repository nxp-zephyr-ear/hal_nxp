...
include_driver_ifdef(CONFIG_DMA_MCUX_LPC		inputmux	driver_inputmux)
...
if(${MCUX_DEVICE} MATCHES "RW61")
  zephyr_include_directories(mcux-sdk/devices/RW612)
  zephyr_include_directories(mcux-sdk/devices/RW612/drivers)
  zephyr_include_directories(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/components/els_pkc/src/platforms/rw61x)
  zephyr_include_directories(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/components/els_pkc/src/platforms/rw61x/inc)
