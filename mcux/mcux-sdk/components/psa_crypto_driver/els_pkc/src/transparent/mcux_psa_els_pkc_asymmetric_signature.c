...
{
    return mcuxClPsaDriver_psa_driver_wrapper_sign_hash( attributes,
                                                       key_buffer,
                                                       key_buffer_size,
                                                       alg,
                                                       input,
...
{
    return mcuxClPsaDriver_psa_driver_wrapper_verify( attributes,
                                                       key_buffer,
                                                       key_buffer_size,
                                                       alg,
                                                       hash,
...
psa_status_t els_pkc_transparent_sign_message(const psa_key_attributes_t *attributes,
                                              ...
                                              size_t signature_size, size_t *signature_length)
{
    return mcuxClPsaDriver_psa_driver_wrapper_sign_message( attributes,
                                                       key_buffer,
                                                       key_buffer_size,
                                                       alg,
                                                       input,
