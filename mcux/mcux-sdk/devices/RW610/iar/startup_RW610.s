...
__vector_table_0x1c
        ...
        DCD     CSS_IRQHandler  ; CSS
        DCD     CSS_GDET_IRQ_IRQHandler  ; CSS IRQ line for GDET error
        DCD     CSS_GDET_ERR_IRQHandler  ; CSS Ungated latched error
...
CSS_IRQHandler
        ...
        BX      R0
        PUBWEAK CSS_GDET_IRQ_IRQHandler
        PUBWEAK CSS_GDET_IRQ_DriverIRQHandler
        SECTION .text:CODE:REORDER:NOROOT(2)
CSS_GDET_IRQ_IRQHandler
        LDR     R0, =CSS_GDET_IRQ_DriverIRQHandler
        BX      R0
        PUBWEAK CSS_GDET_ERR_IRQHandler
        PUBWEAK CSS_GDET_ERR_DriverIRQHandler
        SECTION .text:CODE:REORDER:NOROOT(2)
CSS_GDET_ERR_IRQHandler
        LDR     R0, =CSS_GDET_ERR_DriverIRQHandler
        BX      R0
